...
export function ExerciseCard({ exercise, onStartRest }: ExerciseCardProps) {
  return (
           ...
           <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Info className="h-4 w-4 text-muted-foreground cursor-pointer ml-auto" />
              </TooltipTrigger>
